    <nav class="dark:bg-gray-800 shadow-lg h-screen  w-[250px] py-6 px-4 font-[sans-serif] ">
        ...
        <div class="mt-6 flex flex-col gap-3">
            <div class="flex cursor-pointer group">
                <h6 class="text-gray-300  text-sm font-bold px-4 flex-1">Information</h6>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 fill-gray-600 "
            ...
            <ul class="space-y-1 mt-2 pl-4 flex flex-col">
                <li>
                    <a href="{{ route('showusers') }}"
                        class="text-gray-300 hover:text-black transition-all text-sm flex items-center hover:bg-[#efefef] rounded-md px-4 py-3">
                ...
                <li>
                    <a href="{{ route('userpage') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="bi bi-eye text-6xl" viewBox="0 0 16 16">
                            <path
                                d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z" />
                            <path
                                d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                        </svg>
                        <span class="ps-3">Show Product</span>
                    </a>
                </li>
                <li class="flex  hover:bg-gray-700 rounded px-4 py-3 transition-all">

                    <svg xmlns="http://www.w3.org/2000/svg" style="color: white" fill="currentColor"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="text-gray-300 flex items-center hover:bg-gray-700 rounded   w-full ">
                            Log Out
                        </button>
                    </form>
        ...
        {{-- <div class="mt-6">
        <div class="flex cursor-pointer group">
          <h6 class="text-gray-600 group-hover:text-black text-sm font-bold px-4 flex-1">Income</h6>
          <svg xmlns="http://www.w3.org/2000/svg" class="w-3 fill-gray-600 group-hover:fill-black -rotate-90"
            viewBox="0 0 451.847 451.847">
            <path
              d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z"
              data-original="#000000" />
        ...
        {{-- <div class="mt-6">
        <div class="flex cursor-pointer group">
          <h6 class="text-gray-600 group-hover:text-black text-sm font-bold px-4 flex-1">Actions</h6>
          <svg xmlns="http://www.w3.org/2000/svg" class="w-3 fill-gray-600 group-hover:fill-black -rotate-90"
            viewBox="0 0 451.847 451.847">
            <path
              d="M225.923 354.706c-8.098 0-16.195-3.092-22.369-9.263L9.27 151.157c-12.359-12.359-12.359-32.397 0-44.751 12.354-12.354 32.388-12.354 44.748 0l171.905 171.915 171.906-171.909c12.359-12.354 32.391-12.354 44.744 0 12.365 12.354 12.365 32.392 0 44.751L248.292 345.449c-6.177 6.172-14.274 9.257-22.369 9.257z"
